...
description: "In a distributed system, there are no accurate methods of detecting failure. When a node becomes unreachable, it could be one of the following problems:"
---
# Health checks
...
![Figure 1: Term number competition](/img/consensus/part06-fig3.svg)
