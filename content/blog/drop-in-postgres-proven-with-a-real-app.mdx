...
description: "Connection management is one of the least-scalable parts of Postgres. Because Postgres uses a process-per-connection architecture, production deployments are often fronted by a connection pooler."
date: "2026-05-27"
author: "manan"
