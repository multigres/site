...
![diagram](/img/blog/connection-pooling/per-user-pool-share-round-1-dark.png)
...
![diagram](/img/blog/connection-pooling/per-user-pool-share-round-2-dark.png)

**Round 3.** Only charlie still wants more, but the pool is exhausted. Algorithm halts. Final: alice=2, bob=5, charlie=5.

![diagram](/img/blog/connection-pooling/per-user-pool-share-round-3-dark.png)
...
![diagram](/img/blog/connection-pooling/side-by-side-comparison-dark.png)
...
![diagram](/img/blog/connection-pooling/connection-stacks-dark.png)
