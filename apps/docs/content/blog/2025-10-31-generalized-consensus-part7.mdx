...
description: >-
  This section covers the second part of a leadership change: The discovery of
  the best timeline and its propagation to prepare for the next leadership.
...
<AnimatedSVG
  src={"/img/consensus/part07-fig3.svg"}
