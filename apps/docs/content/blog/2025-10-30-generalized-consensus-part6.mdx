...
description: >-
  This section covers ways to satisfy the prerequisites for a leader change:
  Revoke previous leaderships and recruit nodes for the new leader candidate.
...
<AnimatedSVG
  src={"/img/consensus/part06-fig1.svg"}
...
<div style={{textAlign: 'center', width: '100%', position: 'relative'}}>
  <AnimatedSVG
    src={"/img/consensus/part06-fig2.svg"}
...
<div style={{textAlign: 'center', width: '100%', maxWidth: '100%', overflow: 'hidden', position: 'relative'}}>
  <AnimatedSVG
    src={"/img/consensus/part06-fig3.svg"}
