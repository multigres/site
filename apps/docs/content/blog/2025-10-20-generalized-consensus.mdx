---
title: >-
  Introducing Generalized Consensus: An Alternate Approach to Distributed
  Durability
description: >-
  Today, we're releasing a series that presents a fresh perspective on consensus
  algorithms. Rather than treating consensus as a monolithic black box, we
  propo...
