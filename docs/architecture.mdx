...
<AnimatedSVG
  ...
  onAnimate={(animator) => {
    animator
      ...
      .show("#desc2", { fill: "#1e1e1e"})
      .show("#desc3", { fill: "#2f9e44"})
      .morphText("#desc3", "* N1 sends A to all followers", { duration: 0 })
      .addLabel("step1c")
      .show("#n2a", { autoAlpha: 1, fill: "#2f9e44" })
      .show("#n3a", { autoAlpha: 1, fill: "#2f9e44" })
      .show("#n4a", { autoAlpha: 1, fill: "#2f9e44" })
      .show("#desc3", { fill: "#1e1e1e"})
      .show("#desc4", { fill: "#2f9e44"})
      ...
      .morphText("#desc1", "", { duration: 0 })
      .morphText("#desc2", "", { duration: 0 })
      .morphText("#desc3", "", { duration: 0 })
      .morphText("#desc4", "", { duration: 0 })
      ...
      .show("#desc1", { fill: "#1e1e1e"})
      .show("#desc2", { fill: "#2f9e44"})
      .morphText("#desc2", "* N1 records B as acked for N2", { duration: 0 })
      .addLabel("step4b")
      ...
      .show("#desc2", { fill: "#1e1e1e"})
      .show("#desc3", { fill: "#2f9e44"})
      .morphText("#desc3", "* N3 acks A (delayed)", { duration: 0 })
      .addLabel("step4c")
      .morphText("#n3ack", "N3: A", { duration: 0 })
      .show("#n3ack", { fill: "#2f9e44"})
      .show("#desc3", { fill: "#1e1e1e"})
      .show("#desc4", { fill: "#2f9e44"})
      .show("#desc5", { fill: "#2f9e44"})
      .morphText("#desc4", "* N1 records A as acked for N3.", { duration: 0 })
      .morphText("#desc5", "  A meets durability criteria", { duration: 0 })
      .addLabel("step4")
      .unanimateArrow("#n2n1", { duration: 0 })
      .unanimateArrow("#n3n1", { duration: 0 })
      .unanimateArrow("#n4n1", { duration: 0 })
      .show("#n2n1text", { autoAlpha: 0 })
      .show("#n3n1text", { autoAlpha: 0 })
      .show("#n4n1text", { autoAlpha: 0 })
      .show("#n1b", { fill: "#1e1e1e"})
      .show("#n2b", { fill: "#1e1e1e"})
      .show("#n3b", { fill: "#1e1e1e"})
      .show("#n4b", { fill: "#1e1e1e"})
      .show("#appb", { stroke: "#1e1e1e"})
      .show("#appbtext", { fill: "#1e1e1e"})
      .show("#n2ack", { fill: "#1e1e1e"})
      .show("#n3ack", { fill: "#1e1e1e"})
      .addLabel("step5a")
      .group((a) => {
        a
        .show("#n1applied", { stroke: "#2f9e44"})
        .show("#n1appliedtext", { fill: "#2f9e44"})
        .moveTo("#n1applied", null, {x: 40}, { duration: 1})
        .moveTo("#n1appliedtext", null, {x: 40}, { duration: 1})
      })
      .morphText("#desc1", "* N1 applies A", { duration: 0 })
      .morphText("#desc2", "* N1 Acks A to App", { duration: 0 })
      .morphText("#desc3", "* N1 sends Apply A to followers", { duration: 0 })
      .morphText("#desc4", "  and observers", { duration: 0 })
      .morphText("#desc5", "* Followers and observers apply A", { duration: 0 })
      .addLabel("step5b")
      .group((a) => {
        a
        .show("#appa", { autoAlpha: 0 })
        .show("#appatext", { autoAlpha: 0 })
        .animateArrow("#aapp", { duration: 1 })
        .show("#aapptext", { autoAlpha: 1 })
      })
      .addLabel("step5c")
      .group((a) => {
        a
        .morphText("#n1n2text", "Apply A", { duration: 0 })
        .morphText("#n1n3text", "Apply A", { duration: 0 })
        .morphText("#n1n4text", "Apply A", { duration: 0 })
        .morphText("#n1otext", "Apply A", { duration: 0 })
        .show("#n1n2text", { autoAlpha: 1 })
        .show("#n1n3text", { autoAlpha: 1 })
        .show("#n1n4text", { autoAlpha: 1 })
        .show("#n1otext", { autoAlpha: 1 })
        .animateArrow("#n1n2", { duration: 1 })
        .animateArrow("#n1n3", { duration: 1 })
        .animateArrow("#n1n4", { duration: 1 })
        .animateArrow("#n1o", { duration: 1 })
      })
      .addLabel("step5d")
      .group((a) => {
        a
        .show("#n4applied", { stroke: "#2f9e44"})
        .show("#n4appliedtext", { fill: "#2f9e44"})
        .moveTo("#n4applied", null, {x: 40}, { duration: 1})
        .moveTo("#n4appliedtext", null, {x: 40}, { duration: 1})
      })
      .addLabel("step5")
      .show("#n1n2text", { autoAlpha: 0 })
      .show("#n1n3text", { autoAlpha: 0 })
      .show("#n1n4text", { autoAlpha: 0 })
      .show("#n1otext", { autoAlpha: 0 })
      .unanimateArrow("#n1n2", { duration: 0 })
      .unanimateArrow("#n1n3", { duration: 0 })
      .unanimateArrow("#n1n4", { duration: 0 })
      .unanimateArrow("#n1o", { duration: 0 })
      .unanimateArrow("#aapp", { duration: 0 })
      .show("#aapptext", { autoAlpha: 0 })
      .show("#n1applied", { stroke: "#1e1e1e"})
      .show("#n1appliedtext", { fill: "#1e1e1e"})
      .show("#n4applied", { stroke: "#1e1e1e"})
      .show("#n4appliedtext", { fill: "#1e1e1e"})
      .addLabel("step6a")
      .show("#n3n1", { stroke: "#2f9e44" })
      .morphText("#n3n1text", "Ack B", { duration: 0 })
      .animateArrow("#n3n1", { duration: 1 })
      .show("#n3n1text", { autoAlpha: 1, fill: "#2f9e44" })
      .morphText("#desc1", "* N3 acks B (delayed)", { duration: 0 })
      .morphText("#desc2", "* N1 recods B as acked for N3", { duration: 0 })
      .morphText("#desc3", "* N1 performs all apply steps", { duration: 0 })
      .morphText("#desc4", "  for B as it did for A", { duration: 0 })
      .morphText("#desc5", "", { duration: 0 })
      .addLabel("step6b")
      .show("#n3ack", { fill: "#2f9e44"})
      .morphText("#n3ack", "N3: B", { duration: 0 })
      .addLabel("step6c")
      .show("#n3n1text", { autoAlpha: 0 })
      .unanimateArrow("#n3n1", { duration: 0 })
      .show("#n3ack", { fill: "#1e1e1e" })
      .group((a) => {
        ...
        .show("#n1applied", { stroke: "#2f9e44"})
        .show("#n1appliedtext", { fill: "#2f9e44"})
        .moveTo("#n1applied", null, {x: 80}, { duration: 1})
        .moveTo("#n1appliedtext", null, {x: 80}, { duration: 1})
      })
      .unanimateArrow("#appb", { duration: 0 })
      .show("#appbtext", { autoAlpha: 0 })
      .animateArrow("#bapp", { duration: 1 })
      .show("#bapptext", { autoAlpha: 1, fill: "#2f9e44" })
      .group((a) => {
        a
        .morphText("#n1n2text", "Apply B", { duration: 0 })
        .morphText("#n1n3text", "Apply B", { duration: 0 })
        .morphText("#n1n4text", "Apply B", { duration: 0 })
        .morphText("#n1otext", "Apply B", { duration: 0 })
        .show("#n1n2text", { autoAlpha: 1 })
        .show("#n1n3text", { autoAlpha: 1 })
        .show("#n1n4text", { autoAlpha: 1 })
        .show("#n1otext", { autoAlpha: 1 })
      ...
      .group((a) => {
        ...
        .show("#n4applied", { stroke: "#2f9e44"})
        .show("#n4appliedtext", { fill: "#2f9e44"})
        .moveTo("#n4applied", null, {x: 80}, { duration: 1})
        .moveTo("#n4appliedtext", null, {x: 80}, { duration: 1})
      })
      .addLabel("step7");
  }}
  autoPlay={false}
