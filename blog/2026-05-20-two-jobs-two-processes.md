...
<ThemedImage
alt="Clients connect to a horizontally-scaled fleet of multigateways, which forward to per-instance multipoolers colocated with each Postgres; multiorch coordinates from the side."
sources={{
    light: '/img/blog/connection-pooling/two-jobs-two-processes-light.png',
    dark: '/img/blog/connection-pooling/two-jobs-two-processes-dark.png',
  }}
/>
